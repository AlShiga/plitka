  ...
  data () {
    return {
      ...
      advList: [
        ...
        { name: '[ we are honest ];', img: 'https://i.pinimg.com/originals/ee/fd/36/eefd366e66992e1457a5a4e1a5df1b71.gif' },
        { name: '[ love every project ];', img: 'https://99px.ru/sstorage/86/2020/09/10309201303436361.gif' }
      ]
    }
  },
  components: {
